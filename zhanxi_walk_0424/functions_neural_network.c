//	gcc -Wall -o test_neural_realtime test_neural_realtime.c -lmraa -lfann
...
void neural_network_result(char *ifile_name)
{
    ...
    snprintf(ifile_name, BUFF_SIZE, "trd.txt");
...
*/
		...
		printf("Training file has %d samples\n", N_SAMPLES);
...
/*
		...
		for (i = 0; i < N_SAMPLES; i++) {
			...
			if (index == 0)
				printf("speed 1 walking slow \n");
			else if (index == 1)
				printf("speed 2 walking medium \n");
			else if (index == 2)
				printf("speed 3 walking fast \n");
			else if (index == 3)
				printf("speed 4 walking fast / running slow \n");
			else if (index == 4)
				printf("speed 5 running slow \n");
			else if (index == 5)
				printf("speed 6 running medium \n");
			else if (index == 6)
				printf("speed 7 running fast \n");
